...
import type { RenderMode } from "@/components/ModelView";
...
const PUBLIC_MEDIA_BASE_URL = (process.env.NEXT_PUBLIC_MEDIA_PUBLIC_BASE_URL || "")
  .trim()
  .replace(/\/$/, "");
const LazyStoreExperience = dynamic(() => import("@/components/store/StoreExperience"), {
  ssr: false,
});
const LazyAuthForm = dynamic(() => import("@/components/AuthForm"), {
  ssr: false,
});
      ...
      >
        ...
        >
          ...
          <a
            href="/profile"
            aria-label="Профиль"
            className="relative flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/70 transition hover:text-white sm:h-11 sm:w-11 md:hidden"
          >
